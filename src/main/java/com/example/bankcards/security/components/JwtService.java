...
public class JwtService {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        if (userDetails instanceof BankUserDetails bankUserDetails) {
            claims.put("id", bankUserDetails.getId());
            claims.put("login", bankUserDetails.getUsername());
            claims.put("role", bankUserDetails.getRole());
            claims.put("enabled", bankUserDetails.isEnabled());
        }
